...
<include src="/packages/bcms-ui-base/lib/categories-form" item_id="@current_item.item_id@" parent_id="@current_item.parent_id@" return_url="@return_url" form_mode="display">
</fieldset>
