...
set type_options {{Template template-add} {Folder folder-add} }
ad_form -name add-item  -export {return_url} -form {
	...
	ad_returnredirect "[ad_conn package_url]template/${item_type}?[export_vars {parent_id return_url}]"
}
	...
	-bulk_actions [list \
            "Delete" "${package_url}template/template-delete" "Delete checked items" \
                          ]\
